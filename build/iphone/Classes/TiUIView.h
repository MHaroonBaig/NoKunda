...
/**
 Base class for all NokundaOne views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the NokundaOne view hierarchy (such as wrapped iOS UIViews) was touched.
