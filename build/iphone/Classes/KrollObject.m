...
//@interface NokundaOneObject : NSObject
//@end

@interface NokundaOneObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NokundaOneObject class]])
		{
			for (NSString *key in [[(NokundaOneObject*)o modules] allKeys])
			{
