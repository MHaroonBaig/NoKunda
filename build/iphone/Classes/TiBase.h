...
// in simulator we redefine to format for NokundaOne Developer console
...
{\
	NSString * exceptionName = [@"org.nokundaone." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nokundaone";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINokundaOneNativeItemNone = -1, 
	UINokundaOneNativeItemSpinner = -2,
	UINokundaOneNativeItemProgressBar = -3,
	
	UINokundaOneNativeItemSlider = -4,
	UINokundaOneNativeItemSwitch = -5,
	UINokundaOneNativeItemMultiButton = -6,
	UINokundaOneNativeItemSegmented = -7,
	
	UINokundaOneNativeItemTextView = -8,
	UINokundaOneNativeItemTextField = -9,
	UINokundaOneNativeItemSearchBar = -10,
	
	UINokundaOneNativeItemPicker = -11,
	UINokundaOneNativeItemDatePicker = -12,
	
	UINokundaOneNativeItemInfoLight = -13,
	UINokundaOneNativeItemInfoDark = -14,
	
	UINokundaOneNativeItemDisclosure = -15,
	
	UINokundaOneNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NokundaOne instances of
