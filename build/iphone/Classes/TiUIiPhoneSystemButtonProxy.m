...
MAKE_SYSTEM_PROP(ACTIVITY,UINokundaOneNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UINokundaOneNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UINokundaOneNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UINokundaOneNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UINokundaOneNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UINokundaOneNativeItemContactAdd);
