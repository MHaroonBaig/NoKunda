...
@interface NokundaOneObject : KrollCoverageObject {
#else
@interface NokundaOneObject : KrollObject {
#endif
@private
...
extern NSString * NokundaOne$ModuleRequireFormat;
